...
<head>
    ...
    <title>Employee Panel/Customer - Orders</title>
            ...
            <div class="row content">
                <div style="border: 2px solid black;" class="col-sm-3 sidenav hidden-xs">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="cust_order.php">Customers - Orders Table Wise</a></li>
                ...
                <div class="col-sm-9" style="text-align:center; margin-left:2.5%;">
                    <h2 style="padding-top: 15px; padding-bottom: 15px;">Customers - Orders Table Wise</h2>
                    <br>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Pratham</td>
                            <td>9313626353</td>
                            <td>Pizza, Pan Cake, Minral Water</td>
                            <td>6</td>
                            <td>04:00 PM</td>
                            <td>
                                <button class="button2" style="background-color: blue;">Edit</button>
                            </td>
                        </tr>
                        <tr>
                            <td>Dhyey</td>
