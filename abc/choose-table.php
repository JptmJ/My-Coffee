      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2 style="padding-top: 50px;">Choose Your Table</h2>
          </div>
        </div>
                  ...
                  <div class="row">
                    ...
                    foreach ($result as $r) {
                      ...
                      <div class="col-lg-3" style="min-height: 190px">
                        ...
                        <nav class="menu2">
                          <input type="checkbox" id="restTable<?php echo $table_id; ?>" name="table[]"
                            value="<?php echo $table_id; ?>" class="menu-toggler2 restTable"
