        ...
        <div class="container">
          <div class="row justify-content-center mb-5 pb-5">
            <div class="col-md-7 text-center heading-section ftco-animate">
              <h2 style="padding-top: 50px;">Discover Our Exclusive Menu</h2>
            </div>
          </div>
          <div class="row">
            <div class="col-md-8 dish-menu">
              ...
              <div class="nav nav-pills justify-content-center ftco-animate" id="v-pills-tab" role="tablist"
                ...
                <a class="nav-link py-3 px-4 active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home"
                  role="tab" aria-controls="v-pills-home" aria-selected="true"><span class="flaticon-meat"></span> Fast
                  Food</a>
                <a class="nav-link py-3 px-4" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile"
                  role="tab" aria-controls="v-pills-profile" aria-selected="false"><span class="flaticon-cutlery"></span>
                  Dessert</a>
                    ...
                    <div class="col-lg-12">
                      ...
                      foreach ($result as $r) {
                        ...
                        <div class="menus d-flex ftco-animate">
                          <div class="menu-img"
                            style="background-image: url(dashboard/item-image/<?php echo $r['image']; ?>);"></div>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      ...
                      foreach ($result2 as $r2) {
                        ...
                        <div class="menus d-flex ftco-animate">
                          <div class="menu-img"
                            style="background-image: url(dashboard/item-image/<?php echo $r2['image']; ?>);"></div>
                          <div class="text d-flex">
                            <div class="one-half">
                              <h3>
                                <?php echo $r2['item_name']; ?>
                              </h3>
                              <p><span>
                                  <?php echo $r2['madeby']; ?>
                              </p>
                            ...
                            <div class="one-forth">
                              ...
                              <input type="checkbox" name="item[]" value="<?php echo $r2['id']; ?>"
                                id="menu<?php echo $r2['id']; ?>" data-id="<?php echo $r2['id']; ?>" class="menu">
                            </div>
                            <div class="one-forth" style="text-align: center;">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      ...
                      foreach ($result3 as $r3) {
                        ...
                        <div class="menus d-flex ftco-animate">
                          <div class="menu-img"
                            style="background-image: url(dashboard/item-image/<?php echo $r3['image']; ?>);"></div>
                          <div class="text d-flex">
                            <div class="one-half">
                              <h3>
                                <?php echo $r3['item_name']; ?>
                              </h3>
                              <p><span>
                                  <?php echo $r3['madeby']; ?>
                              </p>
                            ...
                            <div class="one-forth">
                              ...
                              <input type="checkbox" name="item[]" value="<?php echo $r3['id']; ?>"
                                id="menu<?php echo $r3['id']; ?>" data-id="<?php echo $r3['id']; ?>" class="menu" />
                            </div>
                            <div class="one-forth" style="text-align: center;">
                        ...
                        <p class="mb-0"><span>Table No:</span>
                          <?php for ($p = 0; $p < count($_POST["table"]); $p++) {
                            ...
                            foreach ($result4 as $r4) {
                              ?>
                              <a style="color: #FFB911;">
                                <?php echo $r4['table_name']; ?>
                              </a>
                            <?php }
                          } ?>
                        </p>
